<section class="footer row">
    <div class="footer__copyright center col-12">
        ...
        By using this web site you agree to the <a href="/terms-of-use/">terms of use</a>.</p>
        <ul class="footer__social-icons">
            ...
            <a href="https://www.facebook.com/SkywayStatus/" title="Skyway Bridge Status on Facebook" alt="Skyway Bridge Status Facebook link"><li class="fa fa-facebook-square" aria-hidden="true"></li></a>
