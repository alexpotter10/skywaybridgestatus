...
#
# Database: skyway_db
# Generation Time: 2019-02-15 13:53:08 +0000
# ************************************************************
...
# Dump of table active_statements
# ------------------------------------------------------------

DROP VIEW IF EXISTS `active_statements`;

CREATE TABLE `active_statements` (
...
DROP TABLE IF EXISTS `fl511_log`;
...
DROP TABLE IF EXISTS `flhsmv_log`;
...
CREATE TABLE `weather_log` (
  ...
  `precip_1hr_in` varchar(30) DEFAULT NULL,
  `precip_1hr_metric` decimal(8,4) DEFAULT NULL,
  `precip_today_in` decimal(8,4) DEFAULT NULL,
  `precip_today_metric` decimal(8,4) DEFAULT NULL,
...
# Replace placeholder table for active_statements with correct view syntax
# ------------------------------------------------------------

DROP TABLE `active_statements`;

CREATE VIEW `active_statements`
AS SELECT
   'FHP' AS `source`,
